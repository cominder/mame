...
# MaMe & MaRe: Matrix-Based Token Merging and Restoration for Efficient Visual Perception and Synthesis  <a href="[https://arxiv.org/abs/2604.13432](https://arxiv.org/abs/2604.13432)"><img src="https://img.shields.io/static/v1?label=Paper&message=Arxiv:MaMe&color=red&logo=arxiv">
...
![Token merging progression on a bird standing on the wood (single-target scene)](figures/demo_cls.png)
...
![[SD baseline | ToMe-SD | MaMe+MaRe] — Siberian tiger fur detail](<figures/demo_gen.png>)

Moreover, we can control the clarity and sharpness of the generated image by adjusting the similarity threshold. 

![threshold from low to high](figures/paintings.png)
